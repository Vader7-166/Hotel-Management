...
public partial class HotelManagementContext : DbContext
{
    ...
    //=> optionsBuilder.UseSqlServer("Data Source=msi;Initial Catalog=HotelManagement;Persist Security Info=True;User ID=sa;Password=123;Trust Server Certificate=True;");
